window.enableDarkTheme=function() {
    ...
    document.documentElement.style.setProperty('--error-color', '#932828');
    document.documentElement.style.setProperty('--success-color', '#a6d7ce');
...
window.disableDarkTheme=function () {
    ...
    document.documentElement.style.setProperty('--success-color', '#004953');
